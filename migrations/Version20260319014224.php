 ...
 */
final class Version20260319014224 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Drop deprecated vehicle.user_id column and make vehicle.driver_id NOT NULL';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE vehicle DROP user_id, CHANGE driver_id driver_id INT NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE vehicle ADD user_id INT DEFAULT NULL, CHANGE driver_id driver_id INT DEFAULT NULL');
