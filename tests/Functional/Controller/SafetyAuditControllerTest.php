...
final class SafetyAuditControllerTest extends AbstractApiTestCase
{
    ...
    {
        $client = $this->createApiClient();
        $admin = UserFactory::createOne(['roles' => ['ROLE_SCHOOL_ADMIN']]); // no school set
    ...
    public function testSafetyAuditSuccess(): void
    {
        ...
        self::assertArrayHasKey('school', $data);
        self::assertArrayHasKey('safety_score', $data);
        self::assertArrayHasKey('check_in_out_verification', $data);
    }
