...
Returns all routes assigned to the driver, scoped to the parent's school by the
SchoolFilter. The driver detail (`GET /api/drivers/{id}`) also includes route IRIs.
